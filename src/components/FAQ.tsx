    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 max-w-4xl">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl mb-4 sm:mb-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {category.questions.map((item) => {
                    ...
                    return (
                      <div
                        key={itemId}
                        className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-slate-700/50 rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all duration-300"
                      >
                        <button
                          onClick={() => toggleItem(itemId)}
                          className="w-full text-left p-4 sm:p-5 lg:p-6 flex items-start justify-between gap-4 hover:bg-slate-800/40 transition-colors"
                        >
                          <span className="text-base sm:text-lg lg:text-xl font-semibold text-white leading-relaxed pr-2">
                            {item.question}
                          </span>
                          <ChevronDown
                            className={`w-5 h-5 sm:w-6 sm:h-6 text-orange-500 flex-shrink-0 transition-transform duration-300 mt-1 ${
                              isOpen ? 'rotate-180' : ''
                            }`}
                          />
                        </button>
                        ...
                        >
                          <div className="px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                            <div className="text-sm sm:text-base lg:text-lg text-slate-300 leading-relaxed border-t border-slate-700/50 pt-4">
                              {item.answer}
                            </div>
                          </div>
                        </div>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 bg-gradient-to-br from-orange-500/10 to-orange-600/10 border border-orange-500/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 text-center">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-4">
            {content.contactTitle}
          </h3>
          <p className="text-sm sm:text-base lg:text-lg text-slate-300 mb-6 sm:mb-8">
            {content.contactText}
          </p>
